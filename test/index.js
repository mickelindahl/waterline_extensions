...
lab.experiment( 'waterline', function () {
    ...
    lab.test( 'createOrUpdate with and without sort on elements', function ( done ) {
        let data = [];
        let data2 = [];
        ...
        Model.createOrUpdate( options, function ( err, models ) {
            ...
            for ( let i = 0; i < 10; i++ ) {
                ...
                Code.expect(models[i].dummy4[0]<models[i].dummy4[1]).to.be.true()
    ...
    lab.test( 'createOrUpdate append, sort and unique', function ( done ) {
        ...
        for ( let i = 0; i < 2; i++ ) {
            ...
            data4.push( {
                test: new Date( _key_date.valueOf() + i * 3600 ),
                dummy2: ['10'],
                dummy3: [{ id: i + 1, date: new Date( new Date().valueOf() + 3600 * 4 * 1000 ) }, {
                    id: i - 2,
                    date: new Date( new Date().valueOf() + 3600 * 4 * 1000 )
                }],
            } )
        }
